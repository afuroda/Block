...
public class PrefabBlock27 : MonoBehaviour {
    ...
    void Start () {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            if (i <= 9) {
                ...
                GameObject target = Instantiate (obj, new Vector3 (-4.5f + (i * 1.0f), 0.0f, 9.0f), Quaternion.identity);
                ...
                GameObject obj = (GameObject) Resources.Load ("1Cube");
                // Cubeプレハブを元に、インスタンスを生成、
                GameObject target = Instantiate (obj, new Vector3 (-4.5f + ((i - 10) * 1.0f), 0.0f, 7.0f), Quaternion.identity);
                ...
                GameObject obj = (GameObject) Resources.Load ("1Cube");
                // Cubeプレハブを元に、インスタンスを生成、
                GameObject target = Instantiate (obj, new Vector3 (-4.5f + ((i - 20) * 1.0f), 0.0f, 5.0f), Quaternion.identity);
